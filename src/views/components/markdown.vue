<template>
  <div class="components-container">
    ...
    <div class="editor-container">
      <md-editor id='contentEditor' ref="contentEditor" v-model='content' height="200px" :zIndex='20'></md-editor>
    </div>
    <!-- <el-button @click='markdown2Html' style="margin-top:80px;" type="primary">转为HTML
