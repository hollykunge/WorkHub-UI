  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-row type="flex" justify="space-between" :gutter="5">
        ...
        <el-col :span="6">
          <el-input @keyup.enter.native="handleFilter" class="filter-item" placeholder="团队名称" v-model="listQuery.orgName"> </el-input>
        </el-col>
        <el-col :span="2">
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" width="80" label="团队名称">
        <template scope="scope">
      ...
      <el-table-column align="center" width="110" label="上级团队id">
        <template scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form v-if="dialogStatus!='orgUser'" :model="form" :rules="rules" ref="form" label-width="100px">
        <el-form-item label="团队名称" prop="orgname">
          <el-input v-model="form.orgname" placeholder="请输入团队名称"></el-input>
        </el-form-item>
        <el-form-item label="团队代码" prop="orgcode">
          <el-input v-model="form.orgcode" placeholder="请输入团队代码"></el-input>
        </el-form-item>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogUserVisible">
      <team-user :orgList="list" @closeUserDialog="cancel()" ref="orgUser"></team-user>
    </el-dialog>
  </div>
</template>
